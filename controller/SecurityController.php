...
class SecurityController extends AbstractController implements ControllerInterface
{
    ...
    // Méthode pour attribuer le rôle "user" à un utilisateur
    public function setUserRole()
    {
        ...
        // Si un utilisateur a été trouvé, changez son rôle à "user"
        $this->userManager->setUserRoleById($id);

        Session::addFlash('success', 'User role has been set to "user"');
